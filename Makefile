...
.PHONY: all help clean test test-bench-metrics test-rocm test-glm53-kda-rocm test-metal-session-batch test-mxfp4-cuda test-mxfp4-rocm test-cuda-session-batch test-cuda-mixed-batch dspark-acceptance dspark-verify-depth mtp-verify-depth cpu cuda cuda-spark cuda-generic cuda-regression strix-halo rocm
...
cpu: ds4_cli_cpu.o ds4_server_cpu.o ds4_bench_cpu.o ds4_bench_metrics.o ds4_eval_cpu.o ds4_agent_cpu.o ds4_help.o ds4_prompt_prefix.o ds4_web.o ds4_kvstore.o linenoise.o rax.o ds4_gpu_args_cpu.o $(CPU_CORE_OBJS)
...
cuda-regression: tests/cuda_long_context_smoke tests/test_gpu_derived_residency
	./tests/cuda_long_context_smoke
	./tests/test_gpu_derived_residency
...
ds4_cuda_backend_test_hooks.o: ds4_cuda.cu ds4_gpu.h ds4_gpu_mgpu.h ds4_iq2_tables_cuda.inc cuda/mmq/ds4_mmq.h
	$(NVCC) $(NVCCFLAGS) -DDS4_CUDA_BACKEND_TEST_HOOKS -c -o $@ ds4_cuda.cu

tests/test_gpu_derived_residency.o: tests/test_gpu_derived_residency.c ds4_gpu.h
	$(CC) $(CFLAGS) -DDS4_CUDA_BACKEND_TEST_HOOKS -I. -I$(CUDA_HOME)/include -c -o $@ $<

tests/test_gpu_derived_residency: tests/test_gpu_derived_residency.o ds4_cuda_backend_test_hooks.o ds4_image.o $(MMQ_OBJS)
	$(NVCC) $(NVCCFLAGS) -o $@ $^ $(CUDA_LDLIBS)
